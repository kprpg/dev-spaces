# Azure Dev Spaces
AZDS is an Azure developer service that helps teams develop with speed and iterate on Kubernetes. [Click here for more information.](https://aka.ms/signup-azds)
